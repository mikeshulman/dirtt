...
\infer{\oftpe{\Gamma}{\morindco{x_1,x.S}{t}{t'}}{\vcond}{{\subst{\subst{S}{c_1}{x_1}}{t}{x}}}}
      { \begin{array}{l}
          \wfdtp{\C} \\
          \oftp{\dupctx{\Gamma}{\vcond}}{c_0,c_1}{\C} \\
          \ofdtp{\dupctx{\Gamma}{\vcond},\vtptm{x_1}{\co}{\C},\tptmv{x}{\sim}{\Hom{\C}{c_0^\sim}{x_1}}}{S}{\types} \\
...
\FIXME{box contexts for $c_0$, $c_1$}

\FIXME{should the $\sim$ in the type of $x$ be referring to the inner or
  outer duplication/does it matter?}
