...
\begin{mathpar}
	\inferrule{
		...
		\Psi, \strs s, w \strto z : A \cb \Gamma \vdash \introcoend(m) : \coend^{x \strto y : A} M
	}\and
\end{mathpar}
Left rule:
\begin{mathpar}
	\inferrule{
		...
		\flip{\Psi_\Gamma}, \flip{\Psi_M}, \Psi_N, \strs s \cb \Gamma, q : \coend^{x \strto y:A} M \vdash \letexp{\introcoend (m)}{q}{n} : N
	}\and
\end{mathpar}
Computation: $\letexp{\introcoend(m)}{\introcoend(m')}{n} \jdeq n[m'/m]$
...
\begin{mathpar}
	\inferrule{
		...
		\flip{\Psi_\Gamma}, \Psi_M, \strs s \cb \Gamma \vdash \introend(m) : \coend_{x \strto y : A} M
	}\and
\end{mathpar}
Left rule:
\begin{mathpar}
	\inferrule{
		...
		\Psi, \strs s, z \strto w : A \cb \Gamma, f : \coend_{x \strto y : A} M \vdash \letexp{\introend(m)}{f}{n} : N
	}\and
\end{mathpar}
