...
\[ \xymatrix{ V\C \ar[d]|{\bullet}_{\hunit A} \ar@{}[dr]|{\Leftarrow} &
  \dT\ocomp \dS \ar[l] \ar[d]|{\bullet} \ar[r] \ar@{}[dr]|{\Rightarrow} &
  V\C \ar[d]|{\bullet}^{\hunit B}\\
...
\[ \xymatrix{ A \ar[d]_\cong \ar[r]^-\cong & B D D\o \ar[r]^-\cong & C E E\o D D\o & C \ar[d]^\cong \\
   A' \ar[r]_-\cong & B' D' (D')\o \ar[r]_-\cong & C' E' (E')\o D' (D')\o & C' }\]
...
To be a profunctor, $\dl$ must also be acted on by permutations on both sides.
This is evident.
...
We will construct a loose distributive law $\dS \ocomp \dC \to \dC\ocomp \dS$ in $\cL(\dCat)$, analogous to the one constructed in the previous section.
