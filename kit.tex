...
\item We will use the letter $\Gamma$ for a finite list of modules with abstract variables, such as $M(a,b),N(b,c,d),P(e)$.
...
\begin{defn}
  ...
  \[ \mhom{\Gamma(\gamma),(M_1\otimes M_2)(\theta_1,\theta_2)}{\Omega(\omega)} \toiso \mhom{\Gamma(\gamma),M_1(\theta_1),M_2(\theta_2)}{\Omega(\omega)} \]
\end{defn}
...
For instance, the universal morphism of a tensor product could be written in abstract variable notation as $\chi \in \mhom{M_1(\xi_1), M_2(\xi_1)}{(M_1\otimes M_2)(\xi_1,\xi_2)}$.
...
\begin{defn}
  ...
  \[ \mhom{\Gamma(\gamma),(\coend^A M)(\theta)}{\Omega(\omega)} \toiso \mhom{\Gamma(\gamma),M(a,a,\theta)}{\Omega(\omega)} \]
...
\[ \mhom{\Gamma(\gamma),(M\otimes_A N) (\theta_1,\theta_2)}{\Omega(\omega)} \toiso \mhom{\Gamma(\gamma),M(\theta_1,a),N(a,\theta_2)}{\Omega(\omega)} \]
...
\begin{defn}
  ...
  \[ \mhom{\Gamma(\gamma)}{(\tend_A M)(\theta)} \toiso \mhom{\Gamma(\gamma)}{M(a,a,\theta)} \]
  whenever this makes sense.
\end{defn}
...
\begin{defn}
  ...
  \[ \mhom{\Gamma(\gamma)}{(M_1\multimap M_2)(\theta_1,\theta_2)} \toiso
  \mhom{\Gamma(\gamma),M_1(\theta_1)}{M_2(\theta_2)}
  \]
  whenever this makes sense.
\end{defn}

As before, $\xi$'s represent a list of distinct variables, and we assume also that $\xi_1$ and $\xi_2$ are disjoint.
Thus, $\ev$ (``evaluation'') is a single morphism such as $(M_1\multimap M_2)(a,b), M_1(a) \mto M_2(b)$.
...
\[ \mhom{\Gamma(\gamma)}{(M\multimap_A N)(\theta_1,\theta_2)} \toiso
\mhom{\Gamma(\gamma),M(\theta_1,a)}{N(\theta_2,a)}.
\]
