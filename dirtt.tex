...
\begin{mathpar}
  \inferrule{
    \Delta_a \psplit \flip{\Psi_a},\Psi_a \\
    \Delta_M \splits \Psi_M,\flip{\Psi_{\Gamma_M}} \\\\
    \Psi_a \types a:A \\ \Psi_{\Gamma_M},\flip{\Psi_a},\Psi'_a \types \Gamma_M\ctx \\
    \Psi_M,\hat x:\p A, \check x:\m A \types M\type \\\\
    \Delta_M,\Delta_a,\Delta'_a \cb \Gamma_M \types M[(a[\Psi'_a/\Psi_a])/\hat x,\flip{a}/\check x]
    }{
    \Delta_M,\Delta_a \cb \Gamma_M \types \coend^{x:A} M
  }\and
\end{mathpar}
