...
(Can we do something analogous when $v$ appears in $\Gamma$?)
...
The non-binding hom type acts mostly like a linear function type, except that it reverses the variance of category-variables in its domain.
