...
\begin{mathpar}
  \inferrule{
    ...
    \unif{(\Psi_1,\Psi_1')\combineU\Psi_3}{(\Psi_2,\Psi_3')\combineU\Psi_2'}{\rho}{(\Delta_0,\rho_0)}
    }{
    \Delta_0 \cb (\Gamma_1,\Gamma_2 \types J\p(m,a_1,a_2,f):M[a_2/z\p])[\rho_0]
  }
\end{mathpar}
\begin{mathpar}
  \inferrule{
    ...
    \Delta_0 \cb (\Gamma_1,\Gamma_2 \types J\p(m,a_1,a_2,f):M[a_1/z\m])[\rho_0]
  }
\end{mathpar}
...
\begin{mathpar}
  \inferrule{
    ...
    \Delta_0 \cb (\Gamma_1,\Gamma_2,\Gamma_3,f:\mor{A}(a_1,a_2) \\\\
      \quad\types (\transa{r}{n_1}{a_1}{s}{n_2}{a_2}{x}{f}{m}):M)[\rho_0]
  }
\end{mathpar}
\begin{mathpar}
  \inferrule{
    ...
    \Delta_0 \cb (\Gamma_1,\Gamma_2,\Gamma_3,f:\mor{A}(a_1,a_2)
      \types (\transb{r}{n}{a_1}{a_2}{x}{f}{m}):M)[\rho_0]
  }
\end{mathpar}
