...
We seem to need several special cases of elim terms for hom types. The \textsc{Hom Left Rule-B}
case, without substitutions build in, looks like
\begin{mathpar}
  \inferrule{
    \flip{\Psi_1} \types \Gamma \ctx \\
...
\begin{mathpar}
  \inferrule{
    ...
    \Delta_0 \cb (\Gamma_1,\Gamma_2,\Gamma_3,f:\mor{A}(a_1,y) \types \\\\
...
The \textsc{Hom Left Rule-A} splits into two cases, depending on whether the $x$ and $y$ in
