...
\qquad
\Elpn{\piset{x}{S_1}{S_2}} \deq \pitp{x}{\Elpn{S_1}}{\Elpn{S_2}}
\]
...
\qquad
\Elpn{\sigmaset{x}{S_1}{S_2}} \deq \sigmatp{x}{S_1}{\Elpn{S_2}}
\]
...
\infer{\oftp{\Gamma}{\homset{\C}{c_1}{c_2}}{\types}}
      {\wfdtp{\C} &
        ...
        \oftp{\Gamma}{c_2}{\C}}
\qquad
\Elpn{\homset{\C}{c_1}{c_2}} \deq \homtp{\C}{c_1}{c_2}
\]
...
\tptm{t}{\picl{x}{T'}{T}} & \equiv & {(\ulam{x}{t}{x})} &
\end{array} \\
\]
...
\[
\begin{array}{l}
\infer{\oftp{\Gamma}{\morindco{y,x.S}{t}{t'}}{\Elp{\subst{\subst{A}{M_1}{x_1}}{M}{x}}}}
      { \begin{array}{l}
          \wfdtp{\C} \\
