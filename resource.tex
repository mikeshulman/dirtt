...
$\Gamma$ and $M$. It seems possible that these four cases will take different forms after closing
under cut. For instance, in the case when $x$ and $y$ are both in $\Gamma$, the right rule with
built in cut appears to be (FIXME: it is probably possible to rewrite this without needing a
morphism of type contexts):
\begin{mathpar}
  \inferrule{
