...
The right rule is trickier. Here is the most basic form, with no built-in substitutions.
\begin{mathpar}
  \inferrule{
...
With built in substitions, this becomes

\begin{mathpar}
  \inferrule{ d = d_1 \combine d_2 \and 
              d_1 = v_1 \combine v_1' \and 
              d_2 = v_2 \combine v_2' \\\\
